...
| 順番 | ISSUE | タイトル | 状態 | 備考 |
|------|-------|---------|------|------|
| 1（並行） | [#160](https://github.com/scottlz0310/cloud-migrator/issues/160) | トークンバケット + 重み付きコスト | 🟡 基盤実装完了（統合は #163） | `FileCostCalculator` / `WeightedTokenBucket` 追加・設定統合・テスト 42 件 |
